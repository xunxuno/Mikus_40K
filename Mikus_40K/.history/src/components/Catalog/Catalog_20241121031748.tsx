  ...
  useEffect(() => {
    ...
    const cargarProductos = async () => {
      try {
        ...
        setCargando(false); // Cambiamos el estado de carga a false después de cargar los productos
      } catch (error) {
        setError('Hubo un error al cargar los productos');
        setCargando(false); // También cambiamos el estado de carga a false si ocurre un error
      }
    };

    cargarProductos(); // Ejecutamos la función de carga al montar el componente
