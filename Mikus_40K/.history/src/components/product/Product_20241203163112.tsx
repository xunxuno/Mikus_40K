...
const Product: React.FC = () => {
  ...
  const handleAddToCart = async (product: Product) => {
    ...
    try {
      ...
      const cart_productId = await getOrCreatePendingCart(userId);
      console.log('cart_id: ', cart_productId);

      // Verificar si el producto ya está en el carrito
      const existingProduct = await getProductQuantityInCart(cart_productId, product.id);
