  ...
  return (
    <div className="user-details-container">
      ...
      <form className="user-details-form" onSubmit={handleSubmit}>
        ...
        {isEditing ? (
          <button type="submit">Save Changes</button> // El botón solo se muestra cuando está en modo edición
        ) : (
          <button type="button" onClick={() => setIsEditing(true)}> // El botón cambia el estado a modo edición
            Edit
          </button>
        )}
      </form>
